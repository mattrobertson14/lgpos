...
class PatternsControllerTest < ActionController::TestCase
  ...
  test "should create pattern" do
    assert_difference('Pattern.count') do
      post :create, pattern: { abbr: @pattern.abbr, description: @pattern.description, name: @pattern.name, product_line_id: @pattern.product_line_id }
    end
  ...
  test "should update pattern" do
    patch :update, id: @pattern, pattern: { abbr: @pattern.abbr, description: @pattern.description, name: @pattern.name, product_line_id: @pattern.product_line_id }
    assert_redirected_to pattern_path(assigns(:pattern))
  end
