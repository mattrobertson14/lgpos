...
class ProductLinesControllerTest < ActionController::TestCase
  ...
  test "should create product_line" do
    assert_difference('ProductLine.count') do
      post :create, product_line: { abbr: @product_line.abbr, description: @product_line.description, name: @product_line.name }
    end
  ...
  test "should update product_line" do
    patch :update, id: @product_line, product_line: { abbr: @product_line.abbr, description: @product_line.description, name: @product_line.name }
    assert_redirected_to product_line_path(assigns(:product_line))
  end
